...
| 진행률 | M0 6/6 · M1 5/6 · M2 4/6 · 디자인 5/5 · **카드 482장 (흔적 303 · 원천 179) · 실 10편 · 퀴즈 1250문 · 시각자료 726자리** |
| 마지막 세션 | 2026-09-15 (세션 "adriane", R14~R17 — 실제 지도 · 한 카드에 그림 여러 장 · 원천 158장에 두 번째 그림) |
| 공개 주소 | **https://jwj-nick.github.io/ariadne/** |
| 다음 작업 | **오너의 실사용 확인 대기.** 지도부터 다시 보시고, 그 결과에 따라 백로그에서 고른다 |
...
| A12 | 실을 더 쓰기 | 그때그때 | 지금 10편. 조각상·영화 제목·몸의 이름 쪽에 아직 무리가 남아 있다 (D39) |
...
| 2026-09-11 | adriane (R13) | **퀴즈 갈래 둘·별자리·지도·실 3편 (D45~D47).** 거꾸로 묻기 260문 + 하나만 다른 것 68문(퀴즈 1250문). 별자리 7종을 11장에, 지중해 약도를 지명 7장에. 실 7 → 10편 | 오너 피드백 대기 |
| 2026-09-12 | adriane (R14) | **지도를 다시 만들었다 (D48).** 오너가 손으로 그린 약도의 품질을 리젝했다. 위키미디어 공용의 실제 지도 두 벌(지중해·세계)을 걸고, 카드에는 위경도만 적어 그 위에 자리를 찍는다. 좌표를 그대로 넘기는 구글 지도 링크를 함께 달았다. 검사 W11. 단위 131건 · E2E 118건 | 오너 피드백 대기 |
| 2026-09-14 | adriane (R15) | **한 카드에 그림 여러 장 (D49).** 흔적 53장이 감추고 있던 원천의 그림을 함께 걸었다. 지명 7장에 옛 지도, 별자리 7종에 『우라니아의 거울』 성도, 원천 22장에 다른 매체의 한 장을 더했다. `figures` 목록과 딱지 다섯 갈래. 검사 W12. 시각자료 482 → 590자리, 두 장 이상인 카드 85장. 단위 136건 · E2E 121건 | 오너 피드백 대기 |
| 2026-09-15 | adriane (R16) | **원천에 두 번째 그림을 넓혔다.** 성경 17장 · 역사 7장 · 신화 31장 · 문학 7장, 모두 61장. 회화 ↔ 조각 ↔ 유물 ↔ 그 자리처럼 다른 매체로 남은 것을 짝지었다. 라파엘로 아테네 학당은 플라톤과 아리스토텔레스가 나눠 쓰고, 워터하우스의 잠과 죽음은 힙노스와 타나토스가 나눠 쓴다. 원천 179장 가운데 83장이 두 장 이상. 시각자료 651자리 | 오너 피드백 대기 |
| 2026-09-15 | adriane (R17) | **남은 원천 96장을 조사해 75장에 두 번째 그림.** 성경 12 · 신화 46 · 역사 15 · 문학 2. 딱지에 "그 이름은" 을 더했다. 물총새(할키온), 공작(아르고스), 샹젤리제(엘리시온), 히기에이아의 잔(약국), 붓꽃(이리스), 자유의 여신상(리베르타스)처럼 이름이 지금 어디에 남아 있는지를 보여 주는 장이다. 원천 179장 가운데 158장이 두 장 이상. 시각자료 726자리. 남은 21장은 자료가 없거나(카오스·다모클레스·드라콘), 있어도 대표 그림과 같은 것뿐이거나(속죄의 염소·헤르마프로디토스), 저작권이 걸린다(1984) | 오너 피드백 대기 |
